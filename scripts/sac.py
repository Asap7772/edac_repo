...
from .register_v2 import register_new_env
register_new_env()
...
def main(args):
    ...
    variant['trainer_kwargs']['wandb_name'] = experiment_kwargs['exp_postfix']
    ...
    variant['trainer_kwargs']['variant'] = copy.deepcopy(variant)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--wandb_project', default='edac_exps', type=str)
